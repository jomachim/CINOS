...
class Fish extends Entity {
	public static var ALL:Array<Fish> = [];

	public var tw:Tweenie;
	public var activated:Bool = false;
	public var data:Entity_Fish;
	...
	public function new(ent:Entity_Fish) {
		super(ent.cx, ent.cy);
		...
		var anims = dn.heaps.assets.Aseprite.getDict(hxd.Res.atlas.fish);
		spr.anim.registerStateAnim(anims.idle, 0);
		spr.anim.registerStateAnim(anims.jump, 10, () -> activated == true);
		// wid = 16;
		// hei = 16;
		sprScaleX = 1;
		sprScaleY = 1;
